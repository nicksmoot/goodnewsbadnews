    ...
    <div>
      <article style={{ maxWidth: 760, margin: "0 auto", padding: "44px 24px 70px" }}>
        ...
        {detail.hasPhoto && (
          ...
          <img src={detail.photo} alt="" style={{ width: "100%", maxHeight: 400, objectFit: "cover", borderRadius: 14, marginBottom: 26 }} />
        )}
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 10, borderTop: "1px solid #d8cab2", paddingTop: 22 }}>
          <button onClick={() => markSeen(id)} style={{ border: "1px solid #19734a", background: "#19734a14", color: "#19734a", borderRadius: 999, padding: "11px 18px", fontWeight: 700, fontSize: 14, cursor: "pointer" }}>✓ I&apos;ve seen this too · {seenCount}</button>
          <button onClick={() => setHelpOpen((v) => !v)} style={{ border: "1px solid #285d83", background: "#285d831a", color: "#285d83", borderRadius: 999, padding: "11px 18px", fontWeight: 700, fontSize: 14, cursor: "pointer" }}>I can help</button>
          <button onClick={() => toggleFollow(id)} style={{ border: "1px solid #d8cab2", background: "#fffdf8", color: "#161616", borderRadius: 999, padding: "11px 18px", fontWeight: 700, fontSize: 14, cursor: "pointer" }}>{followed[id] ? "✓ Following" : "Follow this signal"}</button>
        </div>
        ...
        {helpOpen && (
          <div style={{ background: "#fffaf1", border: "1px solid #285d834d", borderRadius: 16, padding: 20, marginTop: 18 }}>
            ...
            <select style={{ width: "100%", border: "1px solid #d8cab2", background: "#fffdf8", padding: 11, borderRadius: 10, fontSize: 14, marginBottom: 12 }}>
